...
Best-selling electronics categories.
...
Unzip the Amazon_Electronics_Products_Sales (1).zip file.

Open the .ipynb file located in the Python jupiter notebook folder using Jupyter Notebook, JupyterLab, or VS Code.
